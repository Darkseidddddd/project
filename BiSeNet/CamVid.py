...
if __name__ == '__main__':
    ...
    #data = CamVid(['potsdam/train', 'potsdam/val'],
     #             ['potsdam/train_labels', 'potsdam/val_labels'], '/server_space/RS_2019/BiSeNet-master/potsdam/class_dict_potsdam.csv',(512, 512), loss='crossentropy', mode='val')
    data = CamVid(['potsdam_512_IRRG/test'],['potsdam_512_IRRG/test_label'],'potsdam_512_IRRG/class_dict_potsdam.csv',(512,512),loss='crossentropy',mode='test')
    from model.build_BiSeNet import BiSeNet
    from utils import reverse_one_hot, get_label_info, colour_code_segmentation, compute_global_accuracy

    #label_info = get_label_info('/server_space/RS_2019/BiSeNet-master/potsdam/class_dict_potsdam.csv')
    label_info = get_label_info('potsdam_512_IRRG/class_dict_potsdam.csv')
